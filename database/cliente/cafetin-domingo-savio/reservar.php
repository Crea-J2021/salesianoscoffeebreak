...
if(isset($_POST['reservacion'])){
    ...
    if(isset($usuario) && $usuario != "" && isset($nombre) && $nombre != "" && isset($apellido) && $apellido != "" && isset($carnet) && $carnet != "" && isset($grado) && $grado != "" 
        ...
        $query = "INSERT INTO reservacion_ds (usuario, nombre, apellido, carnet, grado, seccion, especialidad, plato) values('$usuario', '$nombre', '$apellido', '$carnet', '$grado', '$seccion', '$especialidad', '$plato')";
