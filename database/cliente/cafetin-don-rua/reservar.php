...
if(isset($_POST['reservacion'])){
    ...
    && isset($seccion) && $seccion != "" && isset($especialidad) && $especialidad != "" && isset($plato) && $plato != ""){
            $query = "INSERT INTO reservacion_dr (usuario, nombre, apellido, carnet, grado, seccion, especialidad, plato) values('$usuario', '$nombre', '$apellido', '$carnet', '$grado', '$seccion', '$especialidad', '$plato')";
