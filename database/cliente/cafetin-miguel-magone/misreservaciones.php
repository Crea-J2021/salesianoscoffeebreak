...
<body>
    ...
    //MOSTRAR RESERVACION LV
    $queryRlv = "select * from reservacion_mm where usuario = '$iduser'";
    $resultadoRlv = mysqli_query($conn, $queryRlv);
    ?>
    <div class="contenedor">
        ...
        <div class="reserDS">
            <h4>Reservaciones Cafetería Miguel Magone</h4>
            <?php foreach ($resultadoRlv as $row) { ?>
