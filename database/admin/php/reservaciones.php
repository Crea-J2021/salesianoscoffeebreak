...
<body>
    ...
    <div class="header-box">    
        ...
        <div class="reservacion">
            ...
            <div>
                <a class="btn" href="controlador/eliminar-reservacion.php?op=delete&nombre=<?php echo $row['nombre'] ?>">
                ...
                <input id="entregado" class="form-control" type="button" value="Eliminar todas las reservaciones."/>
                </a>
            </div>
            <hr>
        </div>
