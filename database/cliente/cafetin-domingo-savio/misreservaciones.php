...
<body>
    ...
    //MOSTRAR RESERVACION DS
    $queryRds = "select * from reservacion_ds where usuario = '$iduser'";
    $resultadoRds = mysqli_query($conn, $queryRds);
    ?>
    <div class="contenedor">
        ...
        <div class="reserDS">
            <h4>Reservaciones Cafetería Domingo Savio</h4>
            <?php foreach ($resultadoRds as $row) { ?>
