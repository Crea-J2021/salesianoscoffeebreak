...
<body>
    ...
    //MOSTRAR RESERVACION DR
    $queryRdr = "select * from reservacion_dr where usuario = '$iduser'";
    $resultadoRdr = mysqli_query($conn, $queryRdr);    
    ?>
    <div class="contenedor">
        ...
        <div class="reserDS">
            <h4>Reservaciones Cafetería Don Rúa</h4>
            <?php foreach ($resultadoRdr as $row) { ?>
