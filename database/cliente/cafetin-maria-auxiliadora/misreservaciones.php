...
<body>
    ...
    //MOSTRAR RESERVACION MA
    $queryRma = "select * from reservacion_ma where usuario = '$iduser'";
    $resultadoRma = mysqli_query($conn, $queryRma);    
    ?>
    <div class="contenedor">
        ...
        <div class="reserDS">
            <h4>Reservaciones Cafetería María Auxiliadora</h4>
            <?php foreach ($resultadoRma as $row) { ?>
